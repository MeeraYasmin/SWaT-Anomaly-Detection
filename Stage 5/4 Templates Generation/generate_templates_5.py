...
def generate_templates():
    # Define components from the Stage 5 directed graph
    components = ['FIT-501', 'P-501', 'FIT-502', 'FIT-503', 'MV-501', 'MV-502']
    ...
    # Save to templates_5.csv
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_path = os.path.join(script_dir, 'templates_5.csv')
