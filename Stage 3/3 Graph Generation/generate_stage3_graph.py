...
if __name__ == "__main__":
    ...
    stage3_dir = os.path.join(base_dir, "Anomaly_Detection/Project_Steps (Stage 3)")
    graph_dir  = os.path.join(stage3_dir, "3_Graph_Generation")
    ...
    out_csv         = os.path.join(graph_dir, "stage_3_components.csv")
    out_img         = os.path.join(graph_dir, "HMI_Stage3_Graph.png")
    out_connections = os.path.join(graph_dir, "connections_3.csv")
